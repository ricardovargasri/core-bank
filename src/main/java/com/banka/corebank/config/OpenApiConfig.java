...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Cory Bank API", version = "1.0", description = "Sistema de Core Bancario con Seguridad JWT", contact = @Contact(name = "Soporte Bancario")), security = {
